...
## Importing the necessary libraries and custom packages
...
from housing.entity.model_factory import MetricInfoArtifact
from housing.entity.model_factory import ModelFactory
from housing.entity.model_factory import GridSearchedBestModel
...
class ModelTrainer:
    ...
    def initiate_model_trainer(self) -> ModelTrainerArtifact:
        ...
        try:
            ...
            ## train_rmse : root mean squared error of trained dataset
            ## test_rmse  : root mean squared error of test dataset
            ## train_accuracy : R2 score of trained dataset
            ## test_ accuracy : R2 score of test dataset
            ## model_accuracy : average of trained and test accuracy / R2 score
            ## THere is also another parameter "index numjber" it stores the location of the best model generated.
